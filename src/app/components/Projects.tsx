...
const featuredProjects: Project[] = [
  {
    ...
    description: "A dynamic, Next.js 16 web application that uses generative AI to instantly craft and deploy beautiful, responsive developer portfolios. Built with React 19, Tailwind CSS v4, and integrated with Vercel Analytics.",
    link: "https://github.com/KRDIVYANSH121/portfolio",
            ...
            <div key={project.id} className="mb-20 last:mb-0">
              <div className={`relative grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center ${
                ...
                <div className={`${isEven ? "lg:col-start-2" : ""}`}>
                  <p className="text-rose-500 text-lg lg:text-xl mb-2 font-medium">
                    Featured Project
                  </p>
